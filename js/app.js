...
let jediOrder = alert("Arrived " + userName + " i'm glad you have. Yes, hrrmmm.The jedi order this is. Stray to the dark side you must not. Yes, hrrmmm.")
...
/*const userName = prompt('Your name young padawan, what is, hmm?');
console.log(userName);
const jediOrder = alert("Arrived " + userName + " i'm glad you have. Yes, hrrmmm.The jedi order this is. Stray to the dark side you must not. Yes, hrrmmm.")
